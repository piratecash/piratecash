...
private slots:
    ...
    QString BuyPIRATE(QString OrderType, double Quantity, double Rate);
    QString SellPIRATE(QString OrderType, double Quantity, double Rate);
