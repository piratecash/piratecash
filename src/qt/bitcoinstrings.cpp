...
QT_TRANSLATE_NOOP("bitcoin-core", "(9999 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("bitcoin-core", "(default: %s)"),
QT_TRANSLATE_NOOP("bitcoin-core", "(default: 1)"),
QT_TRANSLATE_NOOP("bitcoin-core", "(must be 9999 for mainnet)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Connect to KeePassHttp on port <port> (default: %u)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of Dash Core"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Fee (in DASH/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. Dash Core is shutting down."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "KeePassHttp id for the established association"),
QT_TRANSLATE_NOOP("bitcoin-core", "KeePassHttp key for AES encrypted communication with KeePass"),
QT_TRANSLATE_NOOP("bitcoin-core", "Keep N DASH anonymized (default: %u)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Send trace/debug info to debug.log file (default: %u)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Use KeePass 2 integration using KeePassHttp plugin (default: %u)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Use N separate masternodes to anonymize funds  (2-8, default: %u)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart Dash Core to complete"),
