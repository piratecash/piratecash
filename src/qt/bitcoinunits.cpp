...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("PIRATE");
    case mBTC: return QString("mPIRATE");
    case uBTC: return QString::fromUtf8("μPIRATE");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("piratecash");
    case mBTC: return QString("Milli-piratecash (1 / 1,000)");
    case uBTC: return QString("Micro-piratecash (1 / 1,000,000)");
    default: return QString("???");
    }
}
