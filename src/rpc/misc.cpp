...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                RPCExamples{
                    HelpExampleCli("validateaddress", "\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"") +
                    HelpExampleRpc("validateaddress", "\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"")
                },
            }.Check(request);
...
static UniValue getaddressmempool(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressmempool",
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference in units"},
        ...
        RPCExamples{
            HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"]}'")
    + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"]}")
        },
    }.Check(request);
...
static UniValue getaddressutxos(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressutxos",
        ...
        RPCExamples{
            HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"]}'")
    + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"]}")
        },
    }.Check(request);
...
static UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressdeltas",
        ...
        RPCExamples{
            HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"]}'")
    + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"]}")
        },
    }.Check(request);
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCExamples{
            HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"]}'")
    + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"]}")
        },
    }.Check(request);
...
static UniValue getaddresstxids(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddresstxids",
        ...
        RPCExamples{
            HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"]}'")
    + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"Cbbp3meofT1ESU5p4d9ucXpXw9pxKCMEyi\"]}")
        },
    }.Check(request);
