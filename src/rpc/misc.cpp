...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"piratecash\" activates all Dash-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "piratecash")
    + HelpExampleRpc("debug", "piratecash+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The piratecash address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "corsars", "The difference of corsars"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "corsars", "The number of corsars of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in corsars"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in corsars"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in corsars"},
                    {RPCResult::Type::NUM, "received", "The total number of corsars received (including change)"},
                }},
        RPCExamples{
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Dash features */
    { "piratecash",               "mnsync",                 &mnsync,                 {} },
    { "piratecash",               "spork",                  &spork,                  {"command"} },
    { "piratecash",               "sporkupdate",            &sporkupdate,            {"name","value"} },
