    ...
    return RPCHelpMan{is_composite ? "masternode list" : "masternodelist",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "<outpoint>", "", {
                ...
                RPCResult{"for mode = payee", RPCResult::Type::STR, "<addr>", "PirateCash address used for masternode reward payments"},
                RPCResult{"for mode = owneraddress", RPCResult::Type::STR, "<addr>", "PirateCash address used for payee updates and proposal voting"},
                ...
                RPCResult{"for mode = votingaddress", RPCResult::Type::STR, "<addr>", "PirateCash address used for voting"},
            }
        },
        RPCExamples{""},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
...
{
    static const CRPCCommand commands[]{
        {"pirate", &masternode_help},
        {"pirate", &masternodelist_composite},
        {"pirate", &masternodelist},
        {"pirate", &masternode_connect},
        {"pirate", &masternode_count},
        {"pirate", &masternode_status},
        {"pirate", &masternode_payments},
        {"pirate", &masternode_winners},
    };
