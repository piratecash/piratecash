...
UniValue getaddressinfo(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressinfo",
        "\nReturn information about the given piratecash address. Some information requires the address\n"
        "to be in the wallet.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The piratecash address to get the information of."},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
