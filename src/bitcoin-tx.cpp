...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " piratecash-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  piratecash-tx [options] <hex-tx> [commands]  Update hex-encoded dash transaction\n" +
            "or:     piratecash-tx [options] -create [commands]   Create hex-encoded dash transaction\n" +
            "\n";
