...
$(package)_config_env+=CFLAGS="$(subst c11,gnu89,$($(package)_cflags))"
$(package)_config_env+=CPPFLAGS="$($(package)_cppflags)"
...
ifeq ($(host_arch)_$(host_os),aarch64_darwin)
$(package)_config_opts+=darwin64-arm64-cc no-asm
else
$(package)_config_opts+=$($(package)_config_opts_$(host_arch)_$(host_os))
endif
