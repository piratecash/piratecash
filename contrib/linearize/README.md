...
## Step 0: Install piratecash_hash

https://github.com/piratecash/piratecash_hash
...
JSON-RPC server. Running `piratecashd` or `piratecash-qt -server` will be sufficient.
...
* `input`: piratecashd blocks/ directory containing blkNNNNN.dat
