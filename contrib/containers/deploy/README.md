...
official/supported Docker Images found at https://hub.docker.com/r/piratecash/piratecash-cored/
...
**NOTE: Please update the image description at https://hub.docker.com/r/piratecash/piratecash-cored-develop/ when changing the above text**
