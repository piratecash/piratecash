...
official/supported Docker Images found at https://hub.docker.com/r/cosanta/cosantad/
...
**NOTE: Please update the image description at https://hub.docker.com/r/cosanta/cosantad-develop/ when changing the above text**
