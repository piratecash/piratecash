...
At the first startup Cosanta Core will run a migration process which can take
...
incompatible with older versions of Cosanta Core, so a db migration path was
...
See detailed [set of changes](https://github.com/cosanta/cosanta-core/compare/v19.1.0...cosanta:v19.2.0).
