...
The interface runs on the same port as the JSON-RPC interface, by default port 9606 for mainnet and port 9696 for testnet.
...
* mempoolminfee : (numeric) minimum feerate (COSA per KB) for tx to be accepted
