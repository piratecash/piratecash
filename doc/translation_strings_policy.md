...
This document provides guidelines for internationalization of the PirateCash Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `piratecash_en.ts` remains unchanged.
