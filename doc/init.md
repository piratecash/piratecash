...
Configuration file:  `/etc/dashcore/piratecash.conf`
...
`/etc/dash/piratecash.conf` with the current systemd, OpenRC, and Upstart init
files out-of-the-box. This is because the command line options specified in the
init files take precedence over the configurations in
`/etc/dash/piratecash.conf`. However, some init systems have their own
...
Copy org.dash.piratecashd.plist into ~/Library/LaunchAgents. Load the launch agent by
running `launchctl load ~/Library/LaunchAgents/org.dash.piratecashd.plist`.
...
You will need to modify org.dash.piratecashd.plist if you intend to use it as a
