...
[good first issue](https://github.com/piratecash/piratecash-core/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
[Translation Process](https://github.com/piratecash/piratecash-core/blob/master/doc/translation_process.md)
...
To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for PirateCash](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each PirateCash Core release.
