...
"""Verify that starting piratecashd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start piratecashd with -h for help text")
        ...
        self.log.info("Start piratecashd with -version for version information")
        ...
        self.log.info("Start piratecashdd with -fakearg to make sure it does not start")
