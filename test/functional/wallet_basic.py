...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test sendmany with fee_rate param (explicit fee rate in corsars/B)")
        fee_rate_sat_vb = 2
        ...
        # Test fee_rate values that cannot be represented in corsars/B.
        ...
        for target, mode in product([-1, 0], ["pirate/kb", "corsars/b"]):
        ...
        if not self.options.descriptors:
            ...
            self.log.info("Test sendtoaddress with fee_rate param (explicit fee rate in corsars/B)")
