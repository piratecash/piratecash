...
def get_label(pr_num):
    return requests.get(f'https://api.github.com/repos/piratecash/piratecash-core/pulls/{pr_num}').json()['head']['label']
...
def main():
    ...
    for conflict in conflictPrs:
        ...
        r = requests.get(f'https://api.github.com/repos/piratecash/piratecash-core/pulls/{this_pr_num}')
        ...
        r = requests.get(f'https://github.com/piratecash/piratecash-core/branches/pre_mergeable/{our_pr_label}...{get_label(this_pr_num)}')
